...
public class TestUserResource extends BaseJerseyTest {
    ...
    public void testUserResource() {
        ...
        json = target().path("/user").request()
                ...
                .get(JsonObject.class);
        Assert.assertEquals("alice@home.com", json.getString("email"));
        ...
        json = target().path("/user").request()
                ...
                .get(JsonObject.class);
        Assert.assertEquals("bob@home.com", json.getString("email"));
        ...
        json = target().path("/user").request()
                .cookie(TokenBasedSecurityFilter.COOKIE_NAME, aliceAuthToken)
                .post(Entity.form(new Form()
                        .param("email", " alice2@home.com ")), JsonObject.class);
        ...
        json = target().path("/user").request()
                .cookie(TokenBasedSecurityFilter.COOKIE_NAME, aliceAuthToken)
                .get(JsonObject.class);
        Assert.assertEquals("alice2@home.com", json.getString("email"));
