...
import com.sismics.home.core.util.dbi.ColumnIndexMapper;
import com.sismics.home.core.util.dbi.PaginatedList;
import com.sismics.home.core.util.dbi.PaginatedLists;
import com.sismics.home.core.util.dbi.QueryParam;
import com.sismics.home.core.util.dbi.QueryUtil;
...
public class UserDao {
    ...
    public String create(User user) throws Exception {
        ...
        handle.createStatement("insert into " +
                " T_USER(USE_ID_C, USE_IDROLE_C, USE_USERNAME_C, USE_PASSWORD_C, USE_EMAIL_C, USE_FIRSTCONNECTION_B, USE_CREATEDATE_D)" +
                " values(:id, :roleId, :username, :password, :email, :firstConnection, :createDate)")
                .bind("id", user.getId())
